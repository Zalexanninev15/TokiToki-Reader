...
> [!WARNING]
> Version 0.3 alpha. Plenty is missing and some of it is rough. Telegram is not supported yet.
...
Telegram, notifications, saving posts for offline, attachments when posting.
